...
namespace ClassroomSchedulerCore.Areas.Identity.Pages.Account
{
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        // Assign the appropriate role based on the user's selected role
                        ...
                        _logger.LogInformation($"Assigned role {roleName} to new user.");
